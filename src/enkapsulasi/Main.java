...
public class Main{
    public static void main(String[] args) {
        Player player1 = new Player("Sigit Rendang");
        Armor armor1 = new Armor("Baju koko berlapis baja",5,100);
        Weapon weapon1 = new Weapon("ramuan gila", 10);
        player1.setArmor(armor1);
        player1.setWeapon(weapon1);

        Player player2 = new Player("rusdi ngawi");
        Armor armor2 = new Armor("topi merah perkasa",9,80);
        Weapon weapon2 = new Weapon("cukuran rambut raja fuad", 70);
